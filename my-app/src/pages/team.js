...
const team = () => {
    ...
    return (
        <div>
            <Nav />
            <div class="container my-24 mx-auto md:px-6 max-w-4xl">
                            ...
                            Team.map((teamMember) => (
                                <div class="">
                                    <div
                                        ...
                                        <div class="p-6">
                                            <h5 class="mb-4 text-lg font-bold">{teamMember.name}</h5>
                                            <p class="mb-6">{teamMember.title}</p>
                                            <ul class="mx-auto flex list-inside justify-center">
  
                                                <a href={teamMember.linkedinLink} class="px-2">
